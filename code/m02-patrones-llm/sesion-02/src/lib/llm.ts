/**
 * Misma abstracción multi-provider que el proyecto integrador.
 *
 * Está duplicada a propósito en cada sesión para que las demos sean
 * autocontenidas: puedes clonar la carpeta y correrla aisladamente.
 *
 * En el proyecto integrador real (code/proyecto-integrador/) este
 * archivo es la fuente de verdad. Aquí es una réplica didáctica.
 */
  ...
  switch (provider) {
    ...
    case "google":
      if (!process.env.GOOGLE_GENERATIVE_AI_API_KEY) {
        throw new Error("GOOGLE_GENERATIVE_AI_API_KEY no está definida.");
      }
